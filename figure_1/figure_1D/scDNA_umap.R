...
CODEDIR <- "~/Documents/GitHub/MPNST-Phase-1/figure_1/figure_1D/"
OUTPUTDIR <- "~/Documents/GitHub/MPNST-Zenodo/figure_1/results/figure_1d/"
...
####################################################################################################################################
### Part 3: 13/06/22 Project Visium totalCN single spots onto UMAP (NOT RUN YET)
####################################################################################################################################
if (F) {
  rm_small_cluster <- 0 #Set to 50 or 0
  adj_cluster <- F
