# Code for xgboost-based de-novo SNV classifier development
...
if (F) {
  ...
  # Note that the dataset contains human SNV data and cannot be shared as part of a public repository.
  # Please refer to Data availability section for more information. 
